            ...
            let htmlItem = `
                ...
                `<li class="search-order__box" data-order="order{literal}${data.order_id}{/literal}" onclick="renderDetails({literal}${data.order_id}{/literal})" >
                    <div class="search-order__left">
                        ...
                        <p class="search-order__desc">{literal}${totalProducts}{/literal} items for {literal}$${data.total}{/literal}</p>
                ...
                <li class="search-ready__box search-ready__box--column search-ready__box--nopd" data-order="order{literal}${data.order_id}{/literal}">
                ...
                <li class="search-past__box search-past__box--column search-past__box--nopd" data-order="order{literal}${data.order_id}{/literal}">
                            ...
                            <li class="search-order__details">
                                <div class="search-order__details--left">
                                    ...
                                    <div class="search-order__dish">
                                        ...
                                        <p class="search-order__type">{literal}${pName.category_ids}{/literal}</?>
               ...
               <div class="have-order__mid">
                    <div class="have-order__mid--rel active" data-order="order{literal}${details.order_id}{/literal}">
                        ...
                        <div class="search-order__buttons">
                            ...
                            <input type="button" class="search-order__buttons--btn search-order__buttons--confirm" onclick="getChange({literal}${details.order_id}{/literal})" value="Confirm order" />
                        </div>
                    </div>
                ...
                <div class="have-packing__mid--rel active" data-order="order{literal}${details.order_id}{/literal}">
                    <div class="search-packing__box search-packing__box--mid">
                        <div class="search-packing__left">
                            ...
                            <p class="search-packing__desc search-packing__desc--gray">1 items for {literal}${details.total}{/literal}</p>
...
{literal}
  /*      
        let postUrl = `http://localhost:8080/cart/vendor.php?dispatch=new_orders.change_status&order_id=${id}&status=E`;
            fetch(postUrl, {
            method: "POST",
            headers: {
