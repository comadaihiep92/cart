<?php /* Smarty version Smarty-3.1.21, created on 2020-08-11 11:57:28
         compiled from "C:\xampp\htdocs\cart\design\backend\templates\views\orders\manage_vendor.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11353908545f2d1333642c76-92663689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '452f214c23954ea9552534a7700e5caa84cb5e4f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cart\\design\\backend\\templates\\views\\orders\\manage_vendor.tpl',
      1 => 1597136246,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11353908545f2d1333642c76-92663689',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_5f2d1333788532_16883850',
  'variables' => 
  array (
    'runtime' => 0,
    'statuses' => 0,
...
<?php if ($_valid && !is_callable('content_5f2d1333788532_16883850')) {function content_5f2d1333788532_16883850($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cart/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('text_admin_new_orders','orders','id','status','date','customer','phone','total','id','order','invoice','credit_memo','status','date','customer','phone','tools','view','total','order','order','product','for_this_page_orders','gross_total','totally_paid','for_all_found_orders','gross_total','totally_paid','add_order','bulk_print_invoice','bulk_print_pdf','bulk_print_packing_slip','view_purchased_products','export_selected'));
?>
...
$_smarty_tpl->tpl_vars["o"]->_loop = true;
?>
                <?php if ($_smarty_tpl->tpl_vars['o']->value['status']=="O") {?>
                    <li class="search-order__box" data-order="order<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
" >
...
?>   
                        ...
                        <div class="have-order__mid--rel" data-order="order<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
">
                            <div class="search-order__box search-order__box--mid">
                                <div class="search-order__left">
                                    <h3 class="search-order__id search-order__id--bold">
                                        <?php echo $_smarty_tpl->__("order");?>
 <bdi>#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
</bdi>  <span class="search-order__new">New</span>
                                    </h3>
                                ...
                                <li class="search-order__details">
                                    <div class="search-order__details--left">
                                        ...
                                        <div class="search-order__dish">
                                            <p class="search-order__title">Chicken Biryani <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oi']->value['product'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oi']->value['pname'], ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->tpl_vars["o"]->_loop = true;
?>   
                    <div class="search-order__right-top" data-order="order<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
">
                            ...
                            <div class="search-order__right-content">
                                <h4 class="search-order__right-title">
                                    ...
                                    <p class="search-order__right-price">
                                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['total'], ENT_QUOTES, 'UTF-8');?>
                                ...
                                <div class="search-order__right-info">
                                    ...
                                    <div class="search-order__right-row">
                                        ...
                                        <p class="search-order__right-money"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['discount'], ENT_QUOTES, 'UTF-8');?>
</p>
                                    </div>
                                </div> 
                            </div>
...
<?php echo '<script'; ?>
>
    document.querySelector('.search-order__box[data-order=order78396]').classList.add('active')
    document.querySelector('.have-order__mid--rel[data-order=order78396]').classList.add('active')
    document.querySelector('.search-order__right-top[data-order=order78396]').classList.add('active')
