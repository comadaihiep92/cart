<?php /* Smarty version Smarty-3.1.21, created on 2020-08-11 16:52:27
         compiled from "C:\xampp\htdocs\cart\design\backend\templates\views\addons\components\addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3648975475f32a29bb1fff0-49342595%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cac52dccc8f68e01d0dbb57f0a067f4b6ef7a111' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cart\\design\\backend\\templates\\views\\addons\\components\\addons_list.tpl',
      1 => 1580800651,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '3648975475f32a29bb1fff0-49342595',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f32a29be39901_06332889',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f32a29be39901_06332889')) {function content_5f32a29be39901_06332889($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cart/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
...
?>
        ...
        <?php if (($_smarty_tpl->tpl_vars['a']->value['is_core_addon'])) {?>
            <?php $_smarty_tpl->tpl_vars['addon_classes'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['addon_classes']->value)." filter_source_built_in filter_supplier_".((string)$_smarty_tpl->tpl_vars['a']->value['supplier']), null, 0);?>
        <?php } else { ?>
            <?php $_smarty_tpl->tpl_vars['addon_classes'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['addon_classes']->value)." filter_source_third_party filter_supplier_".((string)$_smarty_tpl->tpl_vars['a']->value['supplier']), null, 0);?>
        <?php }?>
