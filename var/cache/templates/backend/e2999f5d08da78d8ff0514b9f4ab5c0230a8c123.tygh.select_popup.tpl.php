<?php /* Smarty version Smarty-3.1.21, created on 2020-08-11 17:06:54
         compiled from "C:\xampp\htdocs\cart\design\backend\templates\views\orders\components\select_popup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18738798725f32a5fecd3514-46513213%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2999f5d08da78d8ff0514b9f4ab5c0230a8c123' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cart\\design\\backend\\templates\\views\\orders\\components\\select_popup.tpl',
      1 => 1597154792,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18738798725f32a5fecd3514-46513213',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f32a5ff1fd745_01025508',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f32a5ff1fd745_01025508')) {function content_5f32a5ff1fd745_01025508($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cart/app/functions/smarty_plugins\\block.hook.php';
...
?>
                <li <?php if ($_smarty_tpl->tpl_vars['status']->value==$_smarty_tpl->tpl_vars['st']->value||$_smarty_tpl->tpl_vars['val']->value=="Open"||$_smarty_tpl->tpl_vars['val']->value=="Delivered") {?>class="disabled"<?php }?>><a class="<?php if ($_smarty_tpl->tpl_vars['text_wrap']->value) {?>dropdown--text-wrap<?php }?> <?php if ($_smarty_tpl->tpl_vars['confirm']->value) {?>cm-confirm <?php }?>status-link-<?php echo htmlspecialchars(mb_strtolower($_smarty_tpl->tpl_vars['st']->value, 'UTF-8'), ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['status']->value==$_smarty_tpl->tpl_vars['st']->value||$_smarty_tpl->tpl_vars['val']->value=="Open"||$_smarty_tpl->tpl_vars['val']->value=="Delivered") {?>active<?php } else { ?>cm-ajax cm-post<?php if ($_smarty_tpl->tpl_vars['ajax_full_render']->value) {?> cm-ajax-full-render<?php }
